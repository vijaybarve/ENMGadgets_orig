...
MOP <- function(FileType=NA, m1=NA, m2=NA, InpRefFile=NA, InpExtentFile=NA, p1=NA, p2=NA, decil=NA, MxMESS=NA, GetAns=NA, OPRefFileName=NA, OPExtentFileName=NA, FlList=NA, SampleMName=NA, SampleGName=NA, MxMESSOpFile=NA)
{
  Valid = TRUE
