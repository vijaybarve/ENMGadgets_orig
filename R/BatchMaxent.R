#' BatchMaxent - A function to execute Maxent niche modeling algorithm for multiple projections and multiple species.
#' 
...
BatchMaxent <- function(projpath=NA,InpFlName=NA, MNameSameAsSpecies, arglist)
{
    Valid = TRUE
    if (is.na(projpath)){
